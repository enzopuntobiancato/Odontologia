...
//        builder.append("<hr/>");
//        builder.append("<blockquote> <b> Nombre de usuario: ").append(alumno.getUsuario().getNombreUsuario()).append("</b></blockquote>");
//        builder.append("<blockquote> <b> Contraseña: ").append(alumno.getUsuario().getContraseña()).append("</b></blockquote>");
//        builder.append("<hr/>");
//        builder.append("<br/>");
