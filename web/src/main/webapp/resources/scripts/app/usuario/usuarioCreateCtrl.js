...
module.controller('UsuarioCtrl_Create', ['$scope','$rootScope', 'UsuarioSrv', '$state', 'NotificationSrv', 'rolesResponse', function ($scope,$rootScope, service, $state, notification, rolesResponse) {
    $scope.usuario = {};
