...
//
//
//module.controller('UsuarioCtrl_Edit', ['$scope', '$rootScope', 'UsuarioSrv', '$state', 'MessageSrv', 'rolesResponse', 'usuarioResponse', 'tiposDocResponse', 'sexosResponse',
//    function ($scope, $rootScope, service, $state, message, rolesResponse, usuarioResponse, tiposDocResponse, sexosResponse) {
