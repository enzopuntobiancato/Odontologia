...
module.controller('CatedraCtrl_Edit', ['$scope', '$rootScope', '$state', 'CommonsSrv', 'MessageSrv', 'CatedraSrv', 'materiasResponse', 'diasResponse', 'gruposPracticaResponse', 'practicasResponse', '$filter', 'PaginationService', 'catedraResponse', '$mdDialog', '$timeout',
    function ($scope, $rootScope, $state, commons, message, service, materiasResponse, diasResponse, gruposPracticaResponse, practicasResponse, $filter, pagination, catedraResponse, $timeout) {
